namespace AdminClient.PopUp
{
    partial class FacilityInfo_NEWPopUp
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cbo_FacOutsourcing = new System.Windows.Forms.ComboBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.cbo_FacEnable = new System.Windows.Forms.ComboBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.pb_FacPicture)).BeginInit();
			this.SuspendLayout();
			// 
			// pnl_Main
			// 
			...
			this.pnl_Main.Size = new System.Drawing.Size(691, 539);
			// 
			// lbl_Title
			// 
			...
			// Form_close
			// 
			this.Form_close.Location = new System.Drawing.Point(665, 8);
			// 
			// TitleColor
			// 
			this.TitleColor.Size = new System.Drawing.Size(713, 7);
			// 
			// panel1
			// 
			...
			this.panel1.Controls.Add(this.cbo_FacGWH);
			...
			this.panel1.Controls.Add(this.cbo_FacOutsourcing);
			this.panel1.Controls.Add(this.label2);
			this.panel1.Controls.Add(this.label8);
			this.panel1.Controls.Add(this.cbo_FacEnable);
			...
			// txt_FacName
			// 
			this.txt_FacName.Location = new System.Drawing.Point(122, 64);
			this.txt_FacName.Name = "txt_FacName";
			this.txt_FacName.Size = new System.Drawing.Size(188, 25);
			this.txt_FacName.TabIndex = 54;
			// 
			// label1
			// 
			...
			// txt_FacCode
			// 
			this.txt_FacCode.Location = new System.Drawing.Point(122, 33);
			this.txt_FacCode.Name = "txt_FacCode";
			this.txt_FacCode.Size = new System.Drawing.Size(188, 25);
			this.txt_FacCode.TabIndex = 51;
			// 
			// cbo_FacOutsourcing
			// 
			this.cbo_FacOutsourcing.FormattingEnabled = true;
			this.cbo_FacOutsourcing.Location = new System.Drawing.Point(122, 126);
			this.cbo_FacOutsourcing.Name = "cbo_FacOutsourcing";
			this.cbo_FacOutsourcing.Size = new System.Drawing.Size(188, 25);
			this.cbo_FacOutsourcing.TabIndex = 42;
			// 
			// label2
			// 
			...
			// cbo_FacEnable
			// 
			this.cbo_FacEnable.FormattingEnabled = true;
			this.cbo_FacEnable.Location = new System.Drawing.Point(122, 95);
			this.cbo_FacEnable.Name = "cbo_FacEnable";
			this.cbo_FacEnable.Size = new System.Drawing.Size(188, 25);
			this.cbo_FacEnable.TabIndex = 39;
			// 
			// label7
			// 
			...
			// txt_Note
			// 
			this.txt_Note.Location = new System.Drawing.Point(12, 297);
			this.txt_Note.Multiline = true;
			this.txt_Note.Name = "txt_Note";
			this.txt_Note.Size = new System.Drawing.Size(636, 158);
			this.txt_Note.TabIndex = 57;
			// 
			// label9
			// 
			...
			this.label10.Text = "노트";
			// 
			// btn_Delete
			// 
			this.btn_Delete.Location = new System.Drawing.Point(492, 477);
			...
			// btn_Save
			// 
			this.btn_Save.Location = new System.Drawing.Point(572, 477);
			...
			this.Load += new System.EventHandler(this.FacilityPopUp_Load);
			this.pnl_Main.ResumeLayout(false);
			this.pnl_Main.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.Form_close)).EndInit();
			this.panel1.ResumeLayout(false);
			this.panel1.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.pb_FacPicture)).EndInit();
        ...
        private System.Windows.Forms.ComboBox cbo_FacOutsourcing;
        private System.Windows.Forms.Label label2;
        private System.Windows.Forms.Label label8;
        private System.Windows.Forms.ComboBox cbo_FacEnable;
		...
		private System.Windows.Forms.ComboBox cbo_FacGWH;
