...
namespace AdminClient.Forms
{
	partial class ProductionPlan_NEW
	{
		...
		private void InitializeComponent()
		{
			...
			this.btn_CreateWorkOrder.Location = new System.Drawing.Point(1551, 9);
			...
			this.btn_CreateWorkOrder.Visible = false;
			this.btn_CreateWorkOrder.Click += new System.EventHandler(this.btn_CreateWorkOrder_Click);
			// 
			// dgv_ProductionCount
			// 
